...
begin
  dmDB.SoapConnection1.Connected:= not dmDB.SoapConnection1.Connected;
end;
...
begin
  ...
  begin
    ...
    FormDialogo1.ShowDialogo('ultraman80.jpg', 'Você Acertou! Parabéns.');
  end
  else
  begin
   DataSource1.DataSet.FieldByName('CORRECAO').AsBoolean:= false;
   FormDialogo1.ShowDialogo('rb.jpg', 'Você errou! Boa sorte da próxima vez.');
   Beep;
  end;
